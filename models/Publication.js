...
class Publication extends BaseModel {
  ...
  static _formatIncomingPub (reader /*: any */, publication /*: any */) /*: any */ {
    if (_.isString(publication.inLanguage)) {
      publication.inLanguage = [publication.inLanguage]
    }
    ...
    if (publication.readingOrder) { publication.readingOrder = { data: publication.readingOrder } }
    if (publication.links) publication.links = { data: publication.links }
    if (publication.resources) { publication.resources = { data: publication.resources } }
